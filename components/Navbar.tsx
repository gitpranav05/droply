  ...
  <div className="container mx-auto py-3 md:py-4 px-4 md:px-6">
    <div className="flex justify-between items-center">
      ...
      <Link href="/" className="flex items-center gap-2 z-10 group">
        <CloudUpload className="h-7 w-7 text-primary group-hover:scale-110 transition-transform duration-300" />
        ...
        <SignedOut>
          <Link href="/sign-in">
            <Button
              variant="flat"
              color="primary"
              className="rounded-xl px-5 shadow-sm hover:shadow-md transition"
            >
              Sign In
            </Button>
          </Link>
          <Link href="/sign-up">
            <Button
              variant="solid"
              color="primary"
              className="rounded-xl px-5 shadow-md hover:shadow-lg transition"
            >
              Sign Up
            </Button>
          </Link>
          ...
          <div className="flex items-center gap-5">
            ...
            <Dropdown>
              <DropdownTrigger>
                <Button
                  variant="flat"
                  className="p-0 bg-transparent min-w-0 rounded-xl hover:bg-default-100"
                ...
                >
                  <div className="flex items-center gap-2">
                    <Avatar
                      ...
                      className="h-8 w-8 flex-shrink-0 ring-2 ring-primary/20"
                      fallback={<User className="h-4 w-4" />}
                    />
                    <span className="text-default-600 font-medium hidden sm:inline">
              ...
              <DropdownMenu
                ...
                className="rounded-xl shadow-lg border border-default-200"
              >
                <DropdownItem
                  key="profile"
      ...
      <div className="md:hidden flex items-center gap-2">
        <SignedIn>
          <Avatar
            ...
            size="sm"
            src={user?.imageUrl || undefined}
            className="h-9 w-9 flex-shrink-0 ring-2 ring-primary/20"
            fallback={<User className="h-5 w-5" />}
          />
        </SignedIn>
        <button
          className="z-50 p-2 rounded-md bg-default-100 hover:bg-default-200 transition"
      ...
      <div
        ref={mobileMenuRef}
        className={`fixed top-0 right-0 bottom-0 w-4/5 max-w-sm bg-white dark:bg-neutral-900 z-50 flex flex-col pt-20 px-6 shadow-2xl transition-transform duration-300 ease-in-out ${
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-3">
              {!isOnDashboard && (
                <Link
                  href="/dashboard"
                  className="py-2 px-3 hover:bg-default-100 rounded-lg transition-colors"
                  onClick={() => setIsMobileMenuOpen(false)}
                >
                  Dashboard
                </Link>
              ...
              <button
                className="py-2 px-3 text-left text-danger hover:bg-danger-100 dark:hover:bg-danger-900/40 rounded-lg transition-colors mt-4"
                onClick={() => {
                  setIsMobileMenuOpen(false);
                  handleSignOut();
                }}
